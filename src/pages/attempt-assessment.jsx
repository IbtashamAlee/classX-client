    ...
    return (
        <div>
          ...
          <div className="flex justify-center items-center flex-col h-full w-full m-auto fixed">
            ...
            <p className="mt-4 font-semibold text-2xl">Obtained: {submission.obtainedMarks}</p>
            <p className="mt-4 font-semibold text-2xl">Total Marks: {submission.totalMarks}</p>
