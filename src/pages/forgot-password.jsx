  ...
  return (
    <React.Fragment>
      ...
      <div className="flex items-center justify-center flex-col h-full w-full bg-slate-50">
        <div
          className="md:mx-12 sm:mx-auto sm:w-full sm:max-w-md flex items-center justify-center flex-col bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 relative overflow-hidden">
